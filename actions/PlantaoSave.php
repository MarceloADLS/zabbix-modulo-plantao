...
class PlantaoSave extends CController {
    ...
    protected function doAction(): void {
        ...
        foreach ($target_dates as $date) {
            ...
            if ($uid_main !== '') {
                DBexecute(
                    'INSERT INTO module_plantao_schedule (usrgrpid, userid, role_type, schedule_date, created_by, created_at) ' .
                    ...
                    'userid = EXCLUDED.userid, created_by = EXCLUDED.created_by, created_at = EXCLUDED.created_at'
                );
            } else {
